...
----------------------------------------------------------------------------------------------------------------------------------
---- Author: Sunny Piya																								          ----
---- Note: This program takes in the co-creation report generated by social engine and reformats it to suite the client needs ----
----------------------------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------------------------
...
from '/Users/sunnypiya/Desktop/SAB_Ops/PerkinElmer_Start.csv'
delimiter ','
csv header;
...
to '/Users/sunnypiya/Desktop/SAB_Ops/PE_finish.csv'
delimiter ','
csv header;
